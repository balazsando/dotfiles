...
2. Spawn the `enhance-jira-description-agent` via the Agent tool with `run_in_background: false` (this command is interactive — the agent blocks on your approval before updating Jira).
