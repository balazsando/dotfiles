...
Turn `$ARGUMENTS` into one technical backlog ticket. Empty → ask what it should cover.

Load `jira-tickets` — it owns the MCP tool chain, `~/.claude/local/jira-conventions.md`, the
