...
2. Spawn the `create-tech-ticket-agent` via the Agent tool in the foreground (this command is interactive — the agent blocks on your approval before creating anything).
