...
the text after `/ticket-to-merge`; ask for one if it is missing. You orchestrate; the agents
commit.
...
4. **Branch** — `change-delivery` §3, before the first delegation that edits.
